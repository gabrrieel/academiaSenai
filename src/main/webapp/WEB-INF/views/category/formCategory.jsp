...
<head>
<meta charset="UTF-8">
<title>Cadastro das categoria</title>
...
<body>
	...
	<form class="contato-container"action="confirm"  method="post">
		<div>
			<label class="title" for="title">Cadastro de categoria</label>
			<br>
		...
		<div>
		<label for="id_training">ID do treinamento</label>
		 <input  type="text" name="id_training" id="id_training" >
		</div>
